...
public class TcpSocketPlugin extends Plugin {
    ...
    public void connect(PluginCall call) {
        ...
        Integer timeoutOpt = call.getInt("timeout");
        if (timeoutOpt == null) {
            Double timeoutDbl = call.getDouble("timeout");
            timeoutOpt = timeoutDbl != null ? timeoutDbl.intValue() : 8000;
        }
        final int timeoutMs = Math.max(250, timeoutOpt);
